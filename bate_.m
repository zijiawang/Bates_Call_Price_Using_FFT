...
kappa  = 0.495693;      % Heston parameter: mean reversion speed.
theta  = 0.269917;     % Heston parameter: mean reversion level.
sigma  = 0.144449;      % Heston parameter: volatility of vol
rho    = -0.63169;     % Heston parameter: correlation
